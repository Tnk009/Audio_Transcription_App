...
layout = [
    ...
    [sg.Text("thembinkosichikandira@gmail.com", text_color="blue", enable_events=True, key="-WEBSITE-")],
]

# Create the window
window = sg.Window("Video Transcription App - Thembinkosi Chikandira", layout)
...
while True:
    ...
    if event == sg.WINDOW_CLOSED:
        ...
        sg.popup("Visit our website at thembinkosichikandira@gmail.com")
